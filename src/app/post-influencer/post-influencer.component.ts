...
@Component({
  selector: 'app-post-influencer',
  templateUrl: './post-influencer.component.html',
  styleUrls: ['./post-influencer.component.scss']
})
export class PostInfluencerComponent implements OnInit {
  public lat:number = 0; 
  public lng:number = 0;
  zoom=16;
  endpoint1: string = "";
